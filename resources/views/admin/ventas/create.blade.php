...
<div class="container mx-auto p-6">
    ...
    <form action="{{ route('ventas.store') }}" method="POST">
        ...
        <div class="mb-4 mt-4">
            <label>Total</label>
            <input type="number" id="total" name="total" class="border p-2 w-full" value="0" readonly required>
        </div>

        <div class="mt-4">
            <button type="submit" class="bg-green-500 text-white px-3 py-2 rounded">Guardar Venta</button>
        </div>
    </form>
</div>
